...
<?php $__env->startSection('title', 'Edit Buku - E-Perpustakaan'); ?>

<?php $__env->startSection('content'); ?>
<div class="container-fluid px-4 py-4">
    <div class="mb-4">
        <a href="<?php echo e(route('manage.library.books.index')); ?>" class="btn btn-outline-secondary">
        ...
        <div class="col-md-8 mx-auto">
            <div class="card border-0 shadow-sm">
                ...
                <div class="card-body p-4">
                    <form action="<?php echo e(route('manage.library.books.update', $book->id)); ?>" method="POST" enctype="multipart/form-data">
                        <?php echo csrf_field(); ?>
...
unset($__errorArgs, $__bag); ?>" 
                                       value="<?php echo e(old('judul', $book->judul)); ?>" required>
...
unset($__errorArgs, $__bag); ?>" 
                                       value="<?php echo e(old('pengarang', $book->pengarang)); ?>" required>
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div class="row">
                            <div class="col-md-6 mb-3">
                                ...
                                <select name="category_id" class="form-control select-primary <?php $__errorArgs = ['category_id'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>
                            ...
                            <div class="col-md-6 mb-3">
                                ...
                                <input type="text" name="penerbit" class="form-control <?php $__errorArgs = ['penerbit'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>" 
                                       value="<?php echo e(old('penerbit', $book->penerbit)); ?>">
...
unset($__errorArgs, $__bag); ?>" 
                                       value="<?php echo e(old('tahun_terbit', $book->tahun_terbit)); ?>" min="1900" max="<?php echo e(date('Y')); ?>">
...
unset($__errorArgs, $__bag); ?>
                            ...
                            <div class="col-md-4 mb-3">
                                ...
                                <input type="number" name="jumlah_halaman" class="form-control <?php $__errorArgs = ['jumlah_halaman'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>" 
                                       value="<?php echo e(old('jumlah_halaman', $book->jumlah_halaman)); ?>" min="1">
...
unset($__errorArgs, $__bag); ?>"><?php echo e(old('deskripsi', $book->deskripsi)); ?></textarea>
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div class="row">
                            <div class="col-md-6 mb-3">
                                ...
                                <?php endif; ?>
                                <input type="file" name="cover_image" class="form-control <?php $__errorArgs = ['cover_image'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>
                            ...
                            <div class="col-md-6 mb-3">
                                ...
                                <div class="mb-2">
                                    <a href="<?php echo e(route('library.serve-pdf', $book->id)); ?>" target="_blank" class="btn btn-sm btn-outline-primary">
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div class="row">
                            <div class="col-md-6 mb-3">
                                ...
                                <select name="status" class="form-control select-primary <?php $__errorArgs = ['status'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>" required>
                                    <option value="tersedia" <?php echo e(old('status', $book->status) == 'tersedia' ? 'selected' : ''); ?>>Tersedia</option>
                                    <option value="tidak_tersedia" <?php echo e(old('status', $book->status) == 'tidak_tersedia' ? 'selected' : ''); ?>>Tidak Tersedia</option>
                                </select>
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div class="d-flex justify-content-end mt-4" style="gap: 8px;">
                            <a href="<?php echo e(route('manage.library.books.index')); ?>" class="btn btn-secondary">
...
<?php echo $__env->make('layouts.adminty', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\sppqu\sppqu_addon\resources\views/library/books/edit.blade.php ENDPATH**/ ?>