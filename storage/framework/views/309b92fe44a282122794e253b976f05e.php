<?php $__env->startSection('title', 'Keranjang Pembayaran'); ?>
    ...
    <div class="container-fluid">
        <div class="d-flex justify-content-between align-items-center">
            <div class="d-flex align-items-center">
                <a href="<?php echo e(route('student.dashboard')); ?>" class="text-decoration-none me-3">
            ...
            <div>
                <a href="<?php echo e(route('student.bills')); ?>" class="btn btn-outline-success btn-sm" style="font-size: 0.8rem;">
                        ...
                        <div class="card mb-4" style="background: linear-gradient(135deg, #198754 0%, #20c997 100%); color: white; border-radius: 15px; border: none; box-shadow: 0 4px 20px rgba(25, 135, 84, 0.3);">
                            <div class="card-body p-4">
                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        <div style="background: rgba(255, 255, 255, 0.1); border-radius: 10px; padding: 15px; margin-bottom: 15px;">
                                            ...
                                            <div style="font-size: 1.1rem; font-weight: 600; margin-bottom: 0;"><?php echo e($schoolBank->nama_bank ?? 'Belum diatur'); ?></div>
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        <div style="background: rgba(255, 255, 255, 0.1); border-radius: 10px; padding: 15px; margin-bottom: 15px;">
                                            ...
                                            <div class="d-flex align-items-center">
                                                <div style="font-size: 1.1rem; font-weight: 600; margin-bottom: 0; margin-right: 10px;"><?php echo e($schoolBank->norek_bank ?? 'Belum diatur'); ?></div>
                                                <button class="btn btn-sm" style="background: rgba(255, 255, 255, 0.2); border: 1px solid rgba(255, 255, 255, 0.3); color: white; border-radius: 8px; padding: 8px 12px; font-size: 0.8rem;" onclick="copyToClipboard('<?php echo e($schoolBank->norek_bank ?? ''); ?>')">
                                ...
                                <div style="background: rgba(255, 255, 255, 0.1); border-radius: 10px; padding: 15px;">
                                    ...
                                    <div style="font-size: 1.1rem; font-weight: 600; margin-bottom: 0;"><?php echo e($schoolBank->nama_rekening ?? 'Belum diatur'); ?></div>
                                </div>
                            </div>
                        </div>
...
<script>
    ...
    function processPayment(cart, totalAmount) {
        ...
        if (selectedPaymentMethod === 'transfer') {
            ...
            fetch('<?php echo e(route("student.bank-transfer.prepare")); ?>', {
                method: 'POST',
                body: formData,
                headers: {
            ...
            .then(data => {
                ...
                if (data.success) {
                    ...
                    window.location.href = '<?php echo e(route("student.bank-transfer")); ?>';
                } else {
            ...
            fetch('<?php echo e(route("student.cart.payment.ipaymu")); ?>', {
                method: 'POST',
                body: formData,
                headers: {
                    'X-Requested-With': 'XMLHttpRequest'
            ...
            const requestData = {
                ...
                student_id: '<?php echo e(session("student_id")); ?>'
            };
            ...
            const paymentUrl = '<?php echo e(url("/api/midtrans/cart-payment-test")); ?>';
                ...
                if (data.success && data.snap_token) {
                    ...
                    snap.pay(data.snap_token, {
                        onSuccess: function(result) {
                            ...
                            setTimeout(() => {
                                window.location.href = '<?php echo e(route("student.payment.history")); ?>';
                            }, 2000);
                        },
    ...
    function submitBankTransfer() {
        ...
        fetch('<?php echo e(route("student.tabungan.process")); ?>', {
            method: 'POST',
            body: formData,
            headers: {
                'X-Requested-With': 'XMLHttpRequest'
...
<?php $__env->stopPush(); ?> 
<?php echo $__env->make('layouts.student', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\sppqu\sppqu_addon\resources\views/student/cart.blade.php ENDPATH**/ ?>