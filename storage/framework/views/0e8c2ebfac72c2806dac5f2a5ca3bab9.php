                ...
                <div class="register-card">
                    <div class="register-header">
                        <?php if($schoolProfile && $schoolProfile->logo_sekolah): ?>
                            <img src="<?php echo e(asset('storage/' . $schoolProfile->logo_sekolah)); ?>" alt="<?php echo e($schoolProfile->nama_sekolah); ?> Logo" height="60" class="mb-3">
                        <?php else: ?>
                            <i class="fas fa-user-plus fa-3x mb-3"></i>
                        <?php endif; ?>
                        <h3 class="mb-0">Daftar SPMB <?php echo e($schoolProfile->nama_sekolah ?? 'SPPQU'); ?></h3>
                    ...
                    <div class="register-body">
                        ...
                        <form method="POST" action="<?php echo e(route('spmb.register.post')); ?>">
                            <?php echo csrf_field(); ?>
                            <div class="mb-3">
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div class="text-center">
                            ...
                            <a href="<?php echo e(route('spmb.login')); ?>" class="btn btn-outline-primary w-100">
                                <i class="fas fa-sign-in-alt me-2"></i>Login
                            </a>
                        </div>

                        <div class="text-center mt-3">
                            <a href="<?php echo e(route('spmb.index')); ?>" class="text-decoration-none">
...
<?php /**PATH C:\laragon\www\sppqu\sppqu_addon\resources\views/spmb/register.blade.php ENDPATH**/ ?>