...
<?php $__env->startSection('title', 'Kirim Tagihan Masal WhatsApp'); ?>
                    ...
                    <div class="row mb-4">
                        ...
                        <div class="col-md-2">
                            ...
                            <select class="form-control select-primary" id="pos_id" required>
                                ...
                                <?php $__currentLoopData = $posPembayaran; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $pos): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <option value="<?php echo e($pos->pos_id); ?>"><?php echo e($pos->pos_name); ?></option>
                                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                            </select>
                        </div>
                        <div class="col-md-2">
...
<?php echo $__env->make('layouts.adminty', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\sppqu\sppqu_addon\resources\views/bulk-whatsapp/index.blade.php ENDPATH**/ ?>