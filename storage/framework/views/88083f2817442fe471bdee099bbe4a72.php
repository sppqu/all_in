...
<head>
    ...
    <link rel="stylesheet" href="<?php echo e(asset('assets/vendor/css/coreui.min.css')); ?>">
...
<body>
        ...
        <div class="app-sidebar bg-dark text-white p-3" style="min-width:220px;">
            ...
            <div class="sidebar-header text-center p-3 mb-4 rounded-3" style="background: white !important; border: 1px solid #e9ecef !important; position: relative;">
                ...
                <div class="d-flex align-items-center justify-content-center mb-2">
                    <img src="<?php echo e(asset('images/logo.png')); ?>" alt="SPPQU Logo" style="width: 20px; height: 20px; object-fit: contain;" class="me-2">
            ...
            <ul class="nav flex-column mb-4">
                <li class="nav-item">
                    <a class="nav-link <?php echo e(request()->routeIs('manage.foundation.dashboard') ? 'active' : ''); ?>" href="<?php echo e(route('manage.foundation.dashboard')); ?>">
                        <i class="fa fa-building me-2"></i> Dashboard
                    </a>
                </li>
                <li class="nav-item">
                    <a class="nav-link <?php echo e(request()->routeIs('manage.foundation.schools.*') ? 'active' : ''); ?>" href="<?php echo e(route('manage.foundation.schools.index')); ?>">
                        <i class="fa fa-school me-2"></i> Kelola Sekolah
                    </a>
                </li>
                <?php if(auth()->user()->role === 'superadmin'): ?>
                <li class="nav-item">
                    <a class="nav-link <?php echo e(request()->routeIs('*tahun-pelajaran*') ? 'active' : ''); ?>" href="<?php echo e(url('/tahun-pelajaran')); ?>">
                ...
                <li class="nav-item">
                    <a class="nav-link <?php echo e(request()->routeIs('manage.users.*') ? 'active' : ''); ?>" href="<?php echo e(route('manage.users.index')); ?>">
                ...
                <li class="nav-item">
                    ...
                    <div class="collapse" id="monitoringKeuangan">
                        <ul class="nav flex-column ms-3">
                            <li class="nav-item">
                                <a class="nav-link <?php echo e(request()->routeIs('manage.foundation.laporan.pemasukan') ? 'active' : ''); ?>" href="<?php echo e(route('manage.foundation.laporan.pemasukan')); ?>">
                                    <i class="fa fa-arrow-down me-2"></i> Laporan Pemasukan
                                </a>
                            </li>
                            <li class="nav-item">
                                <a class="nav-link <?php echo e(request()->routeIs('manage.foundation.laporan.tunggakan') ? 'active' : ''); ?>" href="<?php echo e(route('manage.foundation.laporan.tunggakan')); ?>">
                                    <i class="fa fa-exclamation-triangle me-2"></i> Tunggakan
                                </a>
                            </li>
                            <li class="nav-item">
                                <a class="nav-link <?php echo e(request()->routeIs('manage.foundation.laporan.jenis-biaya') ? 'active' : ''); ?>" href="<?php echo e(route('manage.foundation.laporan.jenis-biaya')); ?>">
                ...
                <li class="nav-item">
                    <a class="nav-link <?php echo e(request()->routeIs('manage.subscription.*') ? 'active' : ''); ?>" href="<?php echo e(route('manage.subscription.index')); ?>">
                ...
                <?php if(function_exists('menuCan') && menuCan('menu.billing')): ?>
                <li class="nav-item">
                    <a class="nav-link <?php echo e(request()->routeIs('manage.addons.*') ? 'active' : ''); ?>" href="<?php echo e(route('manage.addons.index')); ?>">
            ...
            <ul class="nav flex-column">
                ...
                <li class="nav-item">
                    <a class="nav-link" href="<?php echo e(url('/manage/dashboard')); ?>">
                ...
                <li class="nav-item">
                    ...
                    <ul class="nav-group-items collapse" id="dataMasterSubmenu">
                        <li class="nav-item">
                            <a class="nav-link" href="<?php echo e(url('/tahun-pelajaran')); ?>">
                        ...
                        <li class="nav-item">
                            <a class="nav-link" href="<?php echo e(url('/peserta-didik')); ?>">
                ...
                <li class="nav-item">
                    ...
                    <ul class="nav-group-items collapse" id="pembayaranSubmenu">
                        <li class="nav-item">
                            <a class="nav-link" href="<?php echo e(route('payment.cash')); ?>">
                                <i class="fa fa-cash-register me-2"></i> Pembayaran Tunai
                            </a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link" href="<?php echo e(route('online-payment.index')); ?>">
                ...
                <li class="nav-item">
                    ...
                    <ul class="nav-group-items collapse" id="tabunganSubmenu">
                        <li class="nav-item">
                            <a class="nav-link" href="<?php echo e(route('manage.tabungan.index')); ?>">
                                <i class="fa fa-piggy-bank me-2"></i> Kelola Tabungan
                            </a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link" href="<?php echo e(route('admin.rekapitulasi-tabungan.index')); ?>">
                ...
                <li class="nav-item">
                    ...
                    <ul class="nav-group-items collapse" id="akuntansiSubmenu">
                        <li class="nav-item">
                            <a class="nav-link" href="<?php echo e(route('manage.accounting.kas.index')); ?>">
                                <i class="fa fa-wallet me-2"></i> Daftar Kas
                            </a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link" href="<?php echo e(route('manage.accounting.payment-methods.index')); ?>">
                                <i class="fa fa-credit-card me-2"></i> Metode Pembayaran
                            </a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link" href="<?php echo e(route('manage.accounting.receipt-pos.index')); ?>">
                                <i class="fa fa-plus me-2"></i> Pos Penerimaan
                            </a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link" href="<?php echo e(route('manage.accounting.expense-pos.index')); ?>">
                                <i class="fa fa-minus me-2"></i> Pos Pengeluaran
                            </a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link" href="<?php echo e(route('manage.accounting.cash-transfer.index')); ?>">
                                <i class="fa fa-exchange-alt me-2"></i> Pindah Buku Kas
                            </a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link" href="<?php echo e(route('manage.accounting.cashflow.index')); ?>">
                ...
                <li class="nav-item">
                    ...
                    <ul class="nav-group-items collapse" id="laporanSubmenu">
                        <li class="nav-item">
                            <a class="nav-link" href="<?php echo e(route('manage.laporan-perpos')); ?>">
                                <i class="fa fa-chart-bar me-2"></i> Laporan PerPos
                            </a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link" href="<?php echo e(route('manage.laporan-perkelas')); ?>">
                                <i class="fa fa-chart-pie me-2"></i> Laporan PerKelas
                            </a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link" href="<?php echo e(route('manage.laporan-rekapitulasi')); ?>">
                        ...
                        <li class="nav-item">
                            <a class="nav-link" href="<?php echo e(route('manage.laporan.realisasi-pos')); ?>">
                                <i class="fa fa-target me-2"></i> Analisis Target Capaian
                            </a>
                        </li>
                        <?php endif; ?>
                        <li class="nav-item">
                            <a class="nav-link" href="<?php echo e(route('manage.laporan.tunggakan-siswa')); ?>">
            ...
            <ul class="nav flex-column">
                ...
                <li class="nav-item">
                    <a class="nav-link nav-group-toggle <?php echo e(request()->routeIs('manage.spmb.*') ? 'active' : ''); ?>" href="#spmbSubmenu" data-bs-toggle="collapse" role="button" aria-expanded="<?php echo e(request()->routeIs('manage.spmb.*') ? 'true' : 'false'); ?>" aria-controls="spmbSubmenu">
                        <i class="fa fa-user-graduate me-2"></i> SPMB
                        <i class="fa fa-angle-right nav-group-toggle-icon ms-auto"></i>
                    </a>
                    <ul class="nav-group-items collapse <?php echo e(request()->routeIs('manage.spmb.*') ? 'show' : ''); ?>" id="spmbSubmenu">
                        <li class="nav-item">
                            <a class="nav-link <?php echo e(request()->routeIs('manage.spmb.index') ? 'active' : ''); ?>" href="<?php echo e(route('manage.spmb.index')); ?>">
                                <i class="fa fa-tachometer-alt me-2"></i> Dashboard
                            </a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link <?php echo e(request()->routeIs('manage.spmb.registrations*') ? 'active' : ''); ?>" href="<?php echo e(route('manage.spmb.registrations')); ?>">
                                <i class="fa fa-list me-2"></i> Data Pendaftaran
                            </a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link <?php echo e(request()->routeIs('manage.spmb.settings*') ? 'active' : ''); ?>" href="<?php echo e(route('manage.spmb.settings')); ?>">
                                <i class="fa fa-cog me-2"></i> Pengaturan
                            </a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link <?php echo e(request()->routeIs('manage.spmb.transfer-to-students*') ? 'active' : ''); ?>" href="<?php echo e(route('manage.spmb.transfer-to-students')); ?>">
                                <i class="fa fa-exchange-alt me-2"></i> Transfer ke Students
                            </a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link <?php echo e(request()->routeIs('manage.spmb.form-settings*') ? 'active' : ''); ?>" href="<?php echo e(route('manage.spmb.form-settings.index')); ?>">
                                <i class="fa fa-edit me-2"></i> Pengaturan Form
                            </a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link <?php echo e(request()->routeIs('manage.spmb.payments*') ? 'active' : ''); ?>" href="<?php echo e(route('manage.spmb.payments')); ?>">
                ...
                <?php if(hasBKAddon()): ?>
                <li class="nav-item">
                    <a class="nav-link <?php echo e(request()->is('manage/bk*') ? 'active' : ''); ?>" href="<?php echo e(route('manage.bk.dashboard')); ?>">
                ...
                <li class="nav-item">
                    <a class="nav-link <?php echo e(request()->is('jurnal/*') ? 'active' : ''); ?>" href="<?php echo e(route('jurnal.guru.index')); ?>">
                ...
                <li class="nav-item">
                    <a class="nav-link <?php echo e(request()->is('library/*') || request()->is('manage/library/*') ? 'active' : ''); ?>" href="<?php echo e(route('library.index')); ?>">
            ...
            <ul class="nav flex-column">
                <?php if(menuCan('menu.billing') && in_array(auth()->user()->role, ['admin', 'superadmin'])): ?>
                    <li class="nav-item">
                        <a class="nav-link" href="<?php echo e(route('manage.subscription.index')); ?>" id="billingMenu">
                            <i class="fa fa-file-invoice-dollar me-2"></i> Berlangganan
                        </a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" href="<?php echo e(route('manage.addons.index')); ?>">
                            <i class="fa fa-puzzle-piece me-2"></i> Add-ons Premium
                        </a>
                    </li>
                <?php endif; ?>
                <?php if(function_exists('menuCan') && menuCan('menu.kirim_tagihan')): ?>
                    <li class="nav-item">
                        <a class="nav-link" href="<?php echo e(route('manage.bulk-whatsapp.index')); ?>">
                ...
                <?php if(function_exists('menuCan') && menuCan('menu.users')): ?>
                    <li class="nav-item">
                        <a class="nav-link" href="<?php echo e(route('manage.users.index')); ?>">
                            <i class="fa fa-user-cog me-2"></i> Pengguna
                        </a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" href="<?php echo e(route('manage.users.role-menu')); ?>">
                ...
                <?php if(function_exists('menuCan') && menuCan('menu.general_setting')): ?>
                    <li class="nav-item">
                        <a class="nav-link" href="<?php echo e(route('manage.general.setting')); ?>">
        ...
        <div class="wrapper">
                ...
                <div class="d-flex align-items-center gap-3 ms-auto">
                    <?php if(auth()->check() && (auth()->user()->role === 'superadmin' || auth()->user()->role === 'admin_yayasan')): ?>
                        ...
                        <div class="dropdown">
                            <button class="btn btn-sm btn-outline-primary dropdown-toggle" type="button" data-bs-toggle="dropdown">
                                ...
                                <?php echo e($currentSchool ? Str::limit($currentSchool->nama_sekolah, 20) : 'Pilih Sekolah'); ?>

                            </button>
                            <ul class="dropdown-menu dropdown-menu-end">
                                <li><h6 class="dropdown-header"><?php echo e(Str::limit($foundation->nama_yayasan, 30)); ?></h6></li>
                                ...
                                <li>
                                    <form action="<?php echo e(route('manage.foundation.schools.switch', $school->id)); ?>" method="POST" class="m-0">
                                        <?php echo csrf_field(); ?>
                                        <button type="submit" class="dropdown-item <?php echo e(session('current_school_id') == $school->id ? 'active' : ''); ?>">
                                            <i class="fa fa-check me-2 <?php echo e(session('current_school_id') == $school->id ? '' : 'invisible'); ?>"></i>
                    ...
                    <div class="dropdown">
                        <a href="#" class="d-flex align-items-center dropdown-toggle" data-bs-toggle="dropdown" aria-expanded="false" style="text-decoration:none; color:inherit;">
                            ...
                            <img src="<?php echo e($avatar ? asset('storage/'.$avatar) : asset('images/logo.png')); ?>" alt="User" class="rounded-circle" style="width:32px; height:32px; object-fit:cover;">
                        </a>
                        <ul class="dropdown-menu dropdown-menu-end" style="min-width: 180px;">
                            <?php if(auth()->guard()->check()): ?>
                                <li><a class="dropdown-item" href="<?php echo e(route('manage.profile.edit')); ?>"><i class="fa fa-user me-2"></i> Edit Profil</a></li>
                                <li><hr class="dropdown-divider"></li>
                                <li>
                                    <form method="POST" action="<?php echo e(route('manage.logout')); ?>">
                                        <?php echo csrf_field(); ?>
            ...
            <div class="body p-4">
                ...
                <?php if(session('subscription_warning')): ?>
                    ...
                    <div class="alert alert-<?php echo e($warning['type'] === 'critical' ? 'danger' : ($warning['type'] === 'warning' ? 'warning' : ($warning['type'] === 'error' ? 'danger' : 'info'))); ?> alert-dismissible fade show mb-4" role="alert">
                        <div class="d-flex align-items-center">
                            <i class="fas <?php echo e($warning['type'] === 'critical' ? 'fa-exclamation-triangle' : ($warning['type'] === 'warning' ? 'fa-exclamation-circle' : ($warning['type'] === 'error' ? 'fa-times-circle' : 'fa-info-circle'))); ?> me-2"></i>
                            <div class="flex-grow-1">
                                <?php echo e($warning['message']); ?>

                            </div>
                            <div class="ms-3">
                                <a href="<?php echo e(route('manage.subscription.plans')); ?>" class="btn btn-sm btn-<?php echo e($warning['type'] === 'critical' ? 'danger' : ($warning['type'] === 'warning' ? 'warning' : ($warning['type'] === 'error' ? 'danger' : 'primary'))); ?>">
    ...
    <!-- Subscription Modal -->
    <?php echo $__env->make('components.subscription-modal', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
    
    <!-- Footer -->
    <footer class="footer p-2 d-flex justify-content-between align-items-center">
        <span>&copy; SPPQU</span>
        <span>Versi APP v<?php echo e(config('app.version')); ?></span>
    </footer>
</div>
    ...
    <!-- CoreUI JS -->
    <script src="<?php echo e(asset('assets/vendor/js/coreui.bundle.min.js')); ?>"></script>
    ...
    <script>
        ...
        function proceedLogout() {
            ...
            form.method = 'POST';
            form.action = '<?php echo e(route("manage.logout")); ?>';
                    ...
                    <div class="modal-dialog modal-dialog-centered">
                        <div class="modal-content border-0 shadow-lg">
                            ...
                            <div class="modal-footer border-0">
                                ...
                                <a href="<?php echo e(route('manage.subscription.plans')); ?>" class="btn btn-${colorClass}" onclick="markNotificationAsRead(${notification.id})">
                ...
                html: `
                    <div class="text-center">
                        ...
                        <div class="d-flex justify-content-center gap-2">
                            ...
                            <a href="<?php echo e(route('manage.subscription.plans')); ?>" class="btn btn-warning">
    ...
    <script>
                ...
                document.addEventListener('DOMContentLoaded', function() {
                    ...
                    <?php if(isset($subscriptionNotifications) && $subscriptionNotifications->count() > 0): ?>
                        <?php $__currentLoopData = $subscriptionNotifications; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $notification): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            showSubscriptionNotificationPopup({
                                ...
                                title: '<?php echo e(addslashes($notification->title)); ?>',
                                message: '<?php echo e(addslashes($notification->message)); ?>',
                                icon: '<?php echo e($notification->icon); ?>',
                                color: '<?php echo e($notification->color); ?>'
                            });
                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                    <?php endif; ?>
                });
...
</html> <?php /**PATH C:\laragon\www\sppqu\sppqu_addon\resources\views/layouts/coreui.blade.php ENDPATH**/ ?>