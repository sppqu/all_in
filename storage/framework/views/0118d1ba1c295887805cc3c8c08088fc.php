...
<head>
    ...
    <title><?php echo $__env->yieldContent('title', 'Student Panel'); ?> - SPPQU</title>
    ...
    <style>
        :root {
            --app-version: "v<?php echo e(config('app.version', '1.0.0')); ?>";
            --build-time: "<?php echo e(now()->format('YmdHi')); ?>";
        }
    </style>
...
<body>
    <!-- Simple Header -->
    <?php if(!request()->routeIs('student.cart')): ?>
    <div class="bg-white shadow-sm py-2 sticky-top" style="z-index: 1020;">
        <div class="container-fluid">
            <div class="d-flex justify-content-between align-items-center">
                <div class="d-flex align-items-center">
                    <img src="<?php echo e(asset('images/logo.png')); ?>" alt="SPPQU Logo" style="width: 35px; height: 35px; object-fit: contain;" class="me-3">
                ...
                <div class="d-flex align-items-center">
                    ...
                    <div class="position-relative me-3">
                        <a href="<?php echo e(route('student.cart')); ?>" class="text-decoration-none">
    ...
    <div class="d-flex">
        ...
        <div class="sidebar bg-white shadow-sm" style="width: 250px; min-height: calc(100vh - 60px); position: fixed; left: 0; top: 60px; z-index: 1010;">
            <div class="p-3">
                <div class="list-group list-group-flush">
                    <a href="<?php echo e(route('student.dashboard')); ?>" class="list-group-item list-group-item-action <?php echo e(request()->routeIs('student.dashboard') ? 'active' : ''); ?>">
                        <i class="fas fa-home me-2"></i>Dashboard
                    </a>
                    <a href="<?php echo e(route('student.bills')); ?>" class="list-group-item list-group-item-action <?php echo e(request()->routeIs('student.bills') ? 'active' : ''); ?>">
                        <i class="fas fa-file-invoice me-2"></i>Tagihan
                    </a>

                    <a href="<?php echo e(route('student.tabungan')); ?>" class="list-group-item list-group-item-action <?php echo e(request()->routeIs('student.tabungan') ? 'active' : ''); ?>">
                    ...
                    ?>
                    <?php if($hasBK): ?>
                    <a href="<?php echo e(route('student.bk.index')); ?>" class="list-group-item list-group-item-action <?php echo e(request()->routeIs('student.bk.*') ? 'active' : ''); ?>">
                    ...
                    <?php endif; ?>
                    <a href="<?php echo e(route('student.payment.history')); ?>" class="list-group-item list-group-item-action <?php echo e(request()->routeIs('student.payment.history') ? 'active' : ''); ?>">
                        <i class="fas fa-history me-2"></i>Riwayat Pembayaran
                    </a>
                    <a href="<?php echo e(route('student.profile')); ?>" class="list-group-item list-group-item-action <?php echo e(request()->routeIs('student.profile') ? 'active' : ''); ?>">
        ...
        <!-- Main Content -->
        <div class="main-content flex-grow-1" style="<?php echo e(request()->routeIs('student.cart') ? 'margin-left: 0; padding-top: 0;' : 'margin-left: 250px; padding-top: 15px;'); ?>">
    ...
    <nav class="bottom-nav">
        <div class="row g-0">
            <div class="col">
                <a href="<?php echo e(route('student.bills')); ?>" class="nav-link <?php echo e(request()->routeIs('student.bills') ? 'active' : ''); ?>">
            ...
            <div class="col">
                <?php if($hasEJurnal): ?>
                <a href="<?php echo e(route('student.jurnal.index')); ?>" class="nav-link <?php echo e(request()->routeIs('student.jurnal.*') ? 'active' : ''); ?>">
            ...
            <div class="col">
                <?php if($hasBK): ?>
                <a href="<?php echo e(route('student.bk.index')); ?>" class="nav-link <?php echo e(request()->routeIs('student.bk.*') ? 'active' : ''); ?>">
            ...
            <div class="col">
                <a href="<?php echo e(route('student.profile')); ?>" class="nav-link <?php echo e(request()->routeIs('student.profile') ? 'active' : ''); ?>">
    ...
    <script>
        ...
        function confirmLogout() {
            Swal.fire({
                ...
                if (result.isConfirmed) {
                    ...
                    clearStudentData();
                    window.location.href = '<?php echo e(route('student.logout.get')); ?>';
                }
            });
        }
        ...
        document.addEventListener('DOMContentLoaded', function() {
            ...
            const currentStudentId = '<?php echo e(session("student_id")); ?>';
        ...
        function refreshCsrfToken() {
            fetch('<?php echo e(route("student.refresh-csrf")); ?>', {
                method: 'POST',
                headers: {
...
</html> <?php /**PATH C:\laragon\www\sppqu\sppqu_addon\resources\views/layouts/student.blade.php ENDPATH**/ ?>