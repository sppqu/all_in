...
<div class="container-fluid px-3 py-4">
    ...
    <div class="welcome-banner mb-4">
        <div class="d-flex align-items-center justify-content-between">
            <div>
                ...
                <h4 class="mb-1 fw-bold text-white"><?php echo e(session('student_name')); ?></h4>
                <p class="mb-0 text-white-50 small"><?php echo e(\Carbon\Carbon::now()->isoFormat('dddd, D MMMM YYYY')); ?></p>
            </div>
            <div>
                <?php if($totalBills > 0): ?>
                <div class="chart-container">
                    ...
                    <div class="chart-center-text">
                        <div class="chart-percentage"><?php echo e($progressPercentage); ?>%</div>
    ...
    <div class="alert alert-warning alert-dismissible fade show mb-4" role="alert" style="border-radius: 15px; border-left: 5px solid #ffc107;">
        <div class="d-flex align-items-center">
            ...
            <div>
                ...
                <p class="mb-0 small">Anda memiliki <?php echo e($pendingPayments); ?> pembayaran yang belum selesai. 
                    <a href="<?php echo e(route('student.payment.history')); ?>" class="alert-link fw-bold">Klik di sini</a> untuk melanjutkan.</p>
            </div>
        </div>
    ...
    <div class="row g-3">
            <div class="col-6 col-md-3">
                <a href="<?php echo e(route('student.bills')); ?>" class="quick-action-card">
            ...
            <div class="col-6 col-md-3">
                <a href="<?php echo e(route('student.tabungan')); ?>" class="quick-action-card">
            ...
            <div class="col-6 col-md-3">
                <?php if($hasEJurnal): ?>
                <a href="<?php echo e(route('student.jurnal.create')); ?>" class="quick-action-card">
            ...
            <div class="col-6 col-md-3">
                <a href="<?php echo e(route('student.payment.history')); ?>" class="quick-action-card">
            ...
            <div class="col-6 col-md-3">
                <?php if($hasBK): ?>
                <a href="<?php echo e(route('student.bk.index')); ?>" class="quick-action-card">
            ...
            <div class="col-6 col-md-3">
                <?php if($hasLibrary): ?>
                <a href="<?php echo e(route('student.library')); ?>" class="quick-action-card">
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    const paidBills = <?php echo e($paidBills); ?>;
    const unpaidBills = <?php echo e($unpaidBills); ?>;
    const totalBills = <?php echo e($totalBills); ?>;
...
<?php echo $__env->make('layouts.student', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\sppqu\sppqu_addon\resources\views/student/dashboard.blade.php ENDPATH**/ ?>