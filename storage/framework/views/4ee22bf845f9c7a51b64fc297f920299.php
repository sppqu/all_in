            ...
            <div class="card">
                <div class="card-header d-flex justify-content-between align-items-center">
                    ...
                    <div class="d-flex gap-2">
                        <a href="<?php echo e(route('students.export', request()->query())); ?>" class="btn btn-info text-white">
                            <i class="fas fa-download"></i> Export Data
                        </a>
                        <a href="<?php echo e(url('/students-import')); ?>" class="btn btn-success text-white">
                            <i class="fas fa-upload"></i> Import Data
                        </a>
                        <a href="<?php echo e(route('students.move-class')); ?>" class="btn btn-warning text-white">
                            <i class="fas fa-exchange-alt"></i> Pindah Kelas
                        </a>
                        <a href="<?php echo e(route('students.graduate')); ?>" class="btn btn-success text-white">
                ...
                <div class="card-body">
                    ...
                    <div class="card mb-3">
                        ...
                        <div class="card-body">
                            <form method="GET" action="<?php echo e(route('students.index')); ?>" class="row g-3">
                                <div class="col-md-4">
                                ...
                                <div class="col-md-3">
                                    ...
                                    <select class="form-control select-primary" id="status" name="status">
                                        ...
                                        <option value="0" <?php echo e(request('status') == '0' ? 'selected' : ''); ?>>Non-Aktif</option>
                                    </select>
                                </div>
                    ...
                    <!-- Results Info -->
                    <?php if(request('search') || request('class_id') || request('status')): ?>
                        <div class="alert alert-info">
                            <i class="fas fa-info-circle"></i> 
                            Menampilkan <?php echo e($students->count()); ?> dari <?php echo e($students->total()); ?> data peserta didik
                            <?php if(request('search')): ?>
                                dengan pencarian: <strong>"<?php echo e(request('search')); ?>"</strong>
                            <?php endif; ?>
                            <?php if(request('class_id')): ?>
                                dari kelas: <strong><?php echo e($classes->where('class_id', request('class_id'))->first()->class_name ?? ''); ?></strong>
                            <?php endif; ?>
                            <?php if(request('status')): ?>
                                dengan status: <strong><?php echo e(request('status') == '1' ? 'Aktif' : 'Non-Aktif'); ?></strong>
                            <?php endif; ?>
                        </div>
                    <?php else: ?>
                        <div class="alert alert-info">
                            <i class="fas fa-info-circle"></i> 
                            Menampilkan <?php echo e($students->count()); ?> dari <?php echo e($students->total()); ?> data peserta didik (<?php echo e($students->currentPage()); ?> dari <?php echo e($students->lastPage()); ?> halaman)
                        </div>
                    <?php endif; ?>
                    ...
                    <div class="d-flex justify-content-between align-items-center mb-3">
                        <div class="text-muted">
                            <small>
                                ...
                                (<?php echo e($students->total()); ?> total data)
                            </small>
                        </div>
                        <div class="text-muted">
                            <small>
                                <i class="fas fa-list me-1"></i>
                                <?php echo e($students->perPage()); ?> data per halaman
                            </small>
                        </div>
                    </div>
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        <td style="min-width: 50px; width: 50px; padding-left: 15px; padding-right: 15px;">
                                            <input type="checkbox" name="student_ids[]" value="<?php echo e($student->student_id); ?>" class="form-check-input student-checkbox">
                                        </td>
                                        <td><?php echo e($students->firstItem() + $loop->index); ?></td>
                                        <td>
                                            <?php echo e($student->student_nis); ?>

                                            <?php if($student->student_nisn): ?>
                                                <br><small class="text-muted">NISN: <?php echo e($student->student_nisn); ?></small>
                                            <?php endif; ?>
                                        </td>
                                        <td>
                                            <?php echo e($student->student_full_name); ?>

                                            <?php if($student->age): ?>
                                                <br><small class="text-muted"><?php echo e($student->age); ?> tahun</small>
                                            <?php endif; ?>
                                        </td>
                                        <td>
                                            <span class="badge bg-info"><?php echo e($student->gender_text); ?></span>
                                        </td>
                                        <td>
                                        ...
                                        <td>
                                            <?php echo e($student->student_parent_phone ?? '-'); ?>

                                        </td>
                                        <td>
                                            <?php if($student->student_status): ?>
                                                <span class="badge bg-success"><?php echo e($student->status_text); ?></span>
                                            <?php else: ?>
                                                <span class="badge bg-secondary"><?php echo e($student->status_text); ?></span>
                                            <?php endif; ?>
                                        </td>
                                        <td>
                                            <div class="action-buttons">
                                                <a href="<?php echo e(route('students.show', $student)); ?>" class="detail-link" title="Detail" style="display: inline-block; padding: 0.375rem 0.75rem; background-color: #17a2b8; color: white; text-decoration: none; border-radius: 0.25rem; margin-right: 5px;">
                                                    <i class="fas fa-eye"></i>
                                                </a>
                                                <a href="<?php echo e(route('students.edit', $student)); ?>" class="btn btn-warning btn-sm action-btn" title="Edit">
                                                    <i class="fas fa-edit"></i>
                                                </a>
                                                <button type="button" 
                                                        class="btn btn-secondary btn-sm action-btn btn-reset-password" 
                                                        onclick="openResetPasswordModal('<?php echo e($student->student_id); ?>', '<?php echo e(addslashes($student->student_full_name)); ?>')"
                                                ...
                                                <form action="<?php echo e(route('students.destroy', $student)); ?>" method="POST" class="d-inline delete-form">
                                                    <?php echo csrf_field(); ?>
                                                    <?php echo method_field('DELETE'); ?>
                                                    <button type="button" class="btn btn-danger btn-sm action-btn btn-delete" 
                                                            data-student-name="<?php echo e($student->student_full_name); ?>"
                                                            title="Hapus">
                            ...
                            <div class="d-flex justify-content-center mt-4">
                                <nav aria-label="Page navigation">
                                    <ul class="pagination">
                                        ...
                                        <?php else: ?>
                                            <li class="page-item">
                                                <a class="page-link" href="<?php echo e($students->previousPageUrl()); ?>">Sebelumnya</a>
                                            </li>
                                        <?php endif; ?>
                                        ...
                                        <?php for($page = $startPage; $page <= $endPage; $page++): ?>
                                            ...
                                            <?php else: ?>
                                                <li class="page-item">
                                                    <a class="page-link" href="<?php echo e($students->url($page)); ?>"><?php echo e($page); ?></a>
                                                </li>
                                            <?php endif; ?>
                                        <?php endfor; ?>
                                        ...
                                        <?php if($endPage < $lastPage): ?>
                                            ...
                                            <?php endif; ?>
                                            <li class="page-item">
                                                <a class="page-link" href="<?php echo e($students->url($lastPage)); ?>"><?php echo e($lastPage); ?></a>
                                            </li>
                                        <?php endif; ?>
                                        ...
                                        <?php if($students->hasMorePages()): ?>
                                            <li class="page-item">
                                                <a class="page-link" href="<?php echo e($students->nextPageUrl()); ?>">Selanjutnya</a>
                                            </li>
                                        <?php else: ?>
                                            <li class="page-item disabled">
...
<?php $__env->stopSection(); ?> 
<?php echo $__env->make('layouts.adminty', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\sppqu\sppqu_addon\resources\views/students/index.blade.php ENDPATH**/ ?>