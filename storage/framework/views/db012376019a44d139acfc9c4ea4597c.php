...
<div class="container-fluid px-3 py-4">
    ...
    <div class="page-header mb-4">
        <div class="d-flex justify-content-between align-items-center">
            ...
            <a href="<?php echo e(route('student.bk.create-bimbingan')); ?>" class="btn btn-sm btn-danger" style="border-radius: 10px;">
    ...
    <div class="row g-3 mb-4">
        ...
        <div class="col-md-4">
            <div class="stat-card" style="background: linear-gradient(135deg, #3498db, #2980b9);">
                ...
                <div class="stat-content">
                    <h3><?php echo e($totalBimbingan); ?></h3>
    ...
    <?php if($pelanggaranByKategori->count() > 0): ?>
    <div class="card shadow-sm mb-4" style="border-radius: 15px; border: none;">
        <div class="card-body p-4">
            ...
            <div class="row g-3">
                <?php $__currentLoopData = $pelanggaranByKategori; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $kategori => $data): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <div class="col-md-4">
                    <div class="kategori-card">
                        <div class="d-flex justify-content-between align-items-center">
                            <div>
                                <span class="badge <?php echo e($kategori == 'Ringan' ? 'bg-success' : ($kategori == 'Sedang' ? 'bg-warning' : 'bg-danger')); ?> mb-2">
                                    <?php echo e($kategori); ?>

                                </span>
                                <h4 class="mb-0"><?php echo e($data['count']); ?> kali</h4>
                                <small class="text-muted">Total: <?php echo e($data['poin']); ?> poin</small>
                            </div>
                            <div class="kategori-icon <?php echo e($kategori == 'Ringan' ? 'bg-success' : ($kategori == 'Sedang' ? 'bg-warning' : 'bg-danger')); ?>">
                                <i class="fas fa-exclamation-triangle"></i>
                            </div>
                        </div>
                    </div>
    ...
    <div class="tab-content" id="bkTabsContent">
        ...
        <div class="tab-pane fade show active" id="pelanggaran" role="tabpanel">
            <?php if($pelanggaran->count() > 0): ?>
                <?php $__currentLoopData = $pelanggaran; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <div class="timeline-item mb-3">
                    <div class="timeline-marker <?php echo e($item->kategori == 'Ringan' ? 'bg-success' : ($item->kategori == 'Sedang' ? 'bg-warning' : 'bg-danger')); ?>">
                        <i class="fas fa-exclamation-triangle"></i>
                    </div>
                    <div class="timeline-content">
                        <div class="d-flex justify-content-between align-items-start mb-2">
                            <div>
                                <h6 class="mb-1 fw-bold"><?php echo e($item->nama_pelanggaran); ?></h6>
                                <span class="badge <?php echo e($item->kategori == 'Ringan' ? 'bg-success' : ($item->kategori == 'Sedang' ? 'bg-warning text-dark' : 'bg-danger')); ?> me-2">
                                    <?php echo e($item->kategori); ?>

                                </span>
                                <span class="badge bg-secondary"><?php echo e($item->poin); ?> Poin</span>
                            </div>
                            <small class="text-muted">
                                <i class="fas fa-calendar me-1"></i><?php echo e(\Carbon\Carbon::parse($item->tanggal_pelanggaran)->format('d M Y')); ?>

                            </small>
                        </div>
                        <?php if($item->keterangan): ?>
                        <p class="mb-2 text-muted small"><?php echo e(Str::limit($item->keterangan, 150)); ?></p>
                        <?php endif; ?>
                        <a href="<?php echo e(route('student.bk.show-pelanggaran', $item->id)); ?>" class="btn btn-sm btn-outline-danger">
            ...
            <?php if($bimbingan->count() > 0): ?>
                ...
                <div class="bimbingan-card mb-3">
                    <div class="bimbingan-card-inner">
                        <div class="bimbingan-icon <?php echo e($item->status == 'selesai' ? 'bg-success' : ($item->status == 'berlangsung' ? 'bg-info' : 'bg-warning')); ?>">
                            <i class="fas fa-hand-holding-heart"></i>
                        </div>
                        <div class="bimbingan-content">
                            ...
                            <div class="bimbingan-header">
                                <div class="bimbingan-title-section">
                                    <h6 class="mb-2 fw-bold bimbingan-title"><?php echo e(ucfirst($item->jenis_bimbingan)); ?></h6>
                                    <div class="bimbingan-badges">
                                        <span class="badge <?php echo e($item->status == 'selesai' ? 'bg-success' : ($item->status == 'berlangsung' ? 'bg-info' : ($item->status == 'ditunda' ? 'bg-secondary' : 'bg-warning text-dark'))); ?>">
                                            <?php echo e(ucfirst($item->status)); ?>

                                        </span>
                                        <?php if($item->sesi_ke > 1): ?>
                                        <span class="badge bg-primary">Sesi ke-<?php echo e($item->sesi_ke); ?></span>
                                        <?php endif; ?>
                                    </div>
                                </div>
                                <div class="bimbingan-date">
                                    <small class="text-muted">
                                        <i class="fas fa-calendar me-1"></i><?php echo e(\Carbon\Carbon::parse($item->tanggal_bimbingan)->format('d M Y')); ?>
                            ...
                            <!-- Permasalahan -->
                            <?php if($item->permasalahan): ?>
                            <div class="bimbingan-permasalahan">
                                <p class="mb-0 text-muted small permasalahan-text"><?php echo e(Str::limit($item->permasalahan, 150)); ?></p>
                            </div>
                            <?php endif; ?>
                            
                            <!-- Guru BK -->
                            <?php if($item->nama_guru): ?>
                            <div class="bimbingan-guru">
                                <i class="fas fa-user-tie me-1" style="color: #3498db;"></i>
                                <strong>Guru BK:</strong> <span class="guru-name"><?php echo e($item->nama_guru); ?></span>
                            </div>
                            <?php endif; ?>
                            ...
                            <div class="alert alert-success alert-sm mt-2 mb-0 bimbingan-alert">
                                ...
                                <span class="hasil-text"><?php echo e($item->hasil); ?></span>
                            </div>
                            <?php endif; ?>
                            ...
                            <div class="alert alert-warning alert-sm mt-2 mb-0 bimbingan-alert">
                                ...
                                <span class="tindakan-text"><?php echo e($item->tindakan); ?></span>
                            </div>
                            <?php endif; ?>
                        </div>
                    </div>
            ...
            <?php else: ?>
                <div class="text-center py-5">
                    <div class="empty-state">
                        ...
                        <a href="<?php echo e(route('student.bk.create-bimbingan')); ?>" class="btn btn-primary mt-3" style="border-radius: 10px;">
...
<?php echo $__env->make('layouts.student', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\sppqu\sppqu_addon\resources\views/student/bk/index.blade.php ENDPATH**/ ?>