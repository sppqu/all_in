                ...
                <div class="card-body text-center py-3">
                    <div class="bg-success bg-opacity-10 rounded-circle d-flex align-items-center justify-content-center mx-auto mb-2" style="width: 35px; height: 35px;">
                        <i class="fas fa-arrow-up text-success"></i>
                                         ...
                                         <h6 class="mb-1 fw-bold small">Rp <?php echo e(number_format($totalSetoran, 0, ',', '.')); ?></h6>
                     <small class="text-muted small">Total Setoran</small>
                     <?php if($totalSetoran == 0): ?>
                ...
                <div class="card-body text-center py-3">
                    <div class="bg-danger bg-opacity-10 rounded-circle d-flex align-items-center justify-content-center mx-auto mb-2" style="width: 35px; height: 35px;">
                        <i class="fas fa-arrow-down text-danger"></i>
                                         ...
                                         <h6 class="mb-1 fw-bold small">Rp <?php echo e(number_format($totalPenarikan, 0, ',', '.')); ?></h6>
                     <small class="text-muted small">Total Penarikan</small>
                     <?php if($totalPenarikan == 0): ?>
            ...
            <div class="card border-0 shadow-sm">
                <div class="card-header bg-white border-0 d-flex justify-content-between align-items-center">
                    ...
                    <div class="d-flex align-items-center">
                        ...
                        <span class="text-muted small">Saldo: Rp <?php echo e(number_format($totalTabungan, 0, ',', '.')); ?></span>
                    </div>
                </div>
                <div class="card-body p-0">

                    
                    <?php if($logTabungan->count() > 0): ?>
                        <?php $__currentLoopData = $logTabungan; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $transaksi): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <div class="d-flex justify-content-between align-items-center p-2 <?php echo e(!$loop->last ? 'border-bottom' : ''); ?>">
                            <div class="d-flex align-items-center">
                                <div class="bg-<?php echo e($transaksi->kredit > 0 ? 'success' : 'danger'); ?> bg-opacity-10 rounded-circle d-flex align-items-center justify-content-center me-2" style="width: 30px; height: 30px;">
                                    <i class="fas fa-<?php echo e($transaksi->kredit > 0 ? 'arrow-up' : 'arrow-down'); ?> text-<?php echo e($transaksi->kredit > 0 ? 'success' : 'danger'); ?> small"></i>
                                </div>
                                <div>
                                    <h6 class="mb-0 fw-bold small"><?php echo e($transaksi->kredit > 0 ? 'Setoran' : 'Penarikan'); ?></h6>
                                    <small class="text-muted"><?php echo e(\Carbon\Carbon::parse($transaksi->log_tabungan_input_date)->format('d/m/Y H:i')); ?></small>
                                    <?php if($transaksi->keterangan): ?>
                                        <br><small class="text-muted"><?php echo e($transaksi->keterangan); ?></small>
                                    <?php endif; ?>
                                </div>
                            </div>
                            <div class="text-end">
                                <div class="fw-bold text-<?php echo e($transaksi->kredit > 0 ? 'success' : 'danger'); ?> small">
                                    <?php echo e($transaksi->kredit > 0 ? '+' : '-'); ?> Rp <?php echo e(number_format($transaksi->kredit > 0 ? $transaksi->kredit : $transaksi->debit, 0, ',', '.')); ?>

                                </div>
                                <small class="badge bg-<?php echo e($transaksi->kredit > 0 ? 'success' : 'danger'); ?> bg-opacity-10 text-<?php echo e($transaksi->kredit > 0 ? 'success' : 'danger'); ?>">
                                    <?php echo e($transaksi->kredit > 0 ? 'Setoran' : 'Penarikan'); ?>
...
<?php echo $__env->make('layouts.student', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\sppqu\sppqu_addon\resources\views/student/tabungan.blade.php ENDPATH**/ ?>