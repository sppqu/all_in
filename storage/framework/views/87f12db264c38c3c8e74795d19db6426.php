<?php $__env->startSection('title', 'Transaksi Pembayaran Siswa'); ?>
...
<?php $__env->startSection('head'); ?>
    ...
    <link rel="stylesheet" href="<?php echo e(asset('css/verification-modal.css')); ?>">
    <style>
            ...
            <div class="card">
                <div class="card-header bg-success text-white">
                    ...
                    <div class="card-body">
                        ...
                        <input type="date" class="form-control" id="print_date" value="<?php echo e(date('Y-m-d')); ?>">
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form id="bebasPaymentForm">
                    ...
                    <input type="hidden" id="bebas_payment_date" name="payment_date" value="<?php echo e(date('Y-m-d')); ?>">
...
<?php $__env->stopSection(); ?> 
<?php echo $__env->make('layouts.adminty', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\sppqu\sppqu_addon\resources\views/payment/cash.blade.php ENDPATH**/ ?>