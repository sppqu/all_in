                ...
                <div class="card-body">
                    ...
                    <div class="mb-4">
                        <div class="btn-group w-100" role="group" aria-label="General Setting Tabs" id="settingTabGroup">
                            ...
                            <button type="button" class="btn btn-outline-success <?php echo e(!$hasPaymentGatewayAddon ? 'disabled' : ''); ?>" data-tab="gateway" <?php echo e(!$hasPaymentGatewayAddon ? 'disabled' : ''); ?>>
                                Payment Gateway
                                <?php if(!$hasPaymentGatewayAddon): ?>
                                    <i class="fas fa-lock ms-1"></i>
                                <?php endif; ?>
                            </button>
                            <button type="button" class="btn btn-outline-success <?php echo e(!$hasWhatsAppGatewayAddon ? 'disabled' : ''); ?>" data-tab="wa" <?php echo e(!$hasWhatsAppGatewayAddon ? 'disabled' : ''); ?>>
                                WhatsApp Gateway
                                <?php if(!$hasWhatsAppGatewayAddon): ?>
                                    <i class="fas fa-lock ms-1"></i>
                                <?php endif; ?>
                            </button>
                        </div>
                        ...
                        <div class="row">
                            <div class="col-lg-6">
                                ...
                                <table class="table table-bordered">
                                    <tr><th width="200">Jenjang</th><td><?php echo e($profile->jenjang ?? '-'); ?></td></tr>
                                    <tr><th>Nama Sekolah</th><td><?php echo e($profile->nama_sekolah ?? '-'); ?></td></tr>
                                    <tr><th>Alamat</th><td><?php echo e($profile->alamat ?? '-'); ?></td></tr>
                                    <tr><th>No. Telp</th><td><?php echo e($profile->no_telp ?? '-'); ?></td></tr>
                                    <tr><th>Logo Sekolah</th><td>
                                        <?php if(!empty($profile->logo_sekolah) && $profile->logo_sekolah !== 'Logo'): ?>
                                            <img src="<?php echo e(asset('storage/'.$profile->logo_sekolah)); ?>" alt="Logo" height="60" id="logoPreview">
                                        <?php else: ?>
                            ...
                            <div class="col-lg-6">
                                ...
                                <form method="POST" action="<?php echo e(route('manage.general.setting.update')); ?>" enctype="multipart/form-data" id="profileForm">
                                    <?php echo csrf_field(); ?>
                                    <div class="row mb-3">
                                        <label class="col-sm-3 col-form-label">Jenjang</label>
                                        <div class="col-sm-9">
                                            <input type="text" class="form-control" name="jenjang" value="<?php echo e(old('jenjang', $profile->jenjang ?? '')); ?>">
                                        </div>
                                    </div>
                                    <div class="row mb-3">
                                        <label class="col-sm-3 col-form-label">Nama Sekolah</label>
                                        <div class="col-sm-9">
                                            <input type="text" class="form-control" name="nama_sekolah" value="<?php echo e(old('nama_sekolah', $profile->nama_sekolah ?? '')); ?>">
                                        </div>
                                    </div>
                                    <div class="row mb-3">
                                        <label class="col-sm-3 col-form-label">Alamat</label>
                                        <div class="col-sm-9">
                                            <textarea class="form-control" name="alamat" rows="2"><?php echo e(old('alamat', $profile->alamat ?? '')); ?></textarea>
                                        </div>
                                    </div>
                                    <div class="row mb-3">
                                        <label class="col-sm-3 col-form-label">No. Telp</label>
                                        <div class="col-sm-9">
                                            <input type="text" class="form-control" name="no_telp" value="<?php echo e(old('no_telp', $profile->no_telp ?? '')); ?>">
                                        </div>
                                    </div>
                                    <div class="row mb-3">
                    ...
                    <div id="tab-rekening" class="tab-pane-setting">
                        <div class="row">
                            <div class="col-lg-6">
                                ...
                                <table class="table table-bordered">
                                    <tr><th width="200">No. Rekening</th><td><?php echo e($gateway->norek_bank ?? '-'); ?></td></tr>
                                    <tr><th>Nama Bank</th><td><?php echo e($gateway->nama_bank ?? '-'); ?></td></tr>
                                    <tr><th>Nama Rekening</th><td><?php echo e($gateway->nama_rekening ?? '-'); ?></td></tr>
                                </table>
                            </div>
                            <div class="col-lg-6">
                                <h5 class="mb-3">Edit Rekening Bank</h5>
                                <form method="POST" action="<?php echo e(route('manage.general.setting.rekening')); ?>">
                                    <?php echo csrf_field(); ?>
                                    <div class="row mb-3">
                                        <label class="col-sm-4 col-form-label">No. Rekening</label>
                                        <div class="col-sm-8">
                                            <input type="text" class="form-control" name="norek_bank" value="<?php echo e(old('norek_bank', $gateway->norek_bank ?? '')); ?>">
                                        </div>
                                    </div>
                                    <div class="row mb-3">
                                        <label class="col-sm-4 col-form-label">Nama Bank</label>
                                        <div class="col-sm-8">
                                            <input type="text" class="form-control" name="nama_bank" value="<?php echo e(old('nama_bank', $gateway->nama_bank ?? '')); ?>">
                                        </div>
                                    </div>
                                    <div class="row mb-3">
                                        <label class="col-sm-4 col-form-label">Nama Rekening</label>
                                        <div class="col-sm-8">
                                            <input type="text" class="form-control" name="nama_rekening" value="<?php echo e(old('nama_rekening', $gateway->nama_rekening ?? '')); ?>">
                                        </div>
                                    </div>
                                    <div class="row mb-3">
                    ...
                    <div id="tab-gateway" class="tab-pane-setting">
                            ...
                            <div class="alert alert-warning" role="alert">
                                <div class="d-flex align-items-center">
                                    ...
                                    <div>
                                        ...
                                        <a href="<?php echo e(route('manage.addons.show', 'payment-gateway')); ?>" class="btn btn-primary">
                        ...
                        <div class="row">
                            <div class="col-lg-6">
                                ...
                                <table class="table table-bordered">
                                    <tr><th width="200">Mode</th><td><?php echo e(ucfirst($gateway->ipaymu_mode ?? 'sandbox')); ?></td></tr>
                                    <tr><th>Status</th><td><?php echo e($gateway->ipaymu_is_active ? 'Aktif' : 'Tidak Aktif'); ?></td></tr>
                                    <tr><th>VA Key</th><td><?php echo e($gateway->ipaymu_va ? '***' . substr($gateway->ipaymu_va, -4) : '-'); ?></td></tr>
                                    <tr><th>API Key</th><td><?php echo e($gateway->ipaymu_api_key ? '***' . substr($gateway->ipaymu_api_key, -4) : '-'); ?></td></tr>
                                </table>
                            </div>
                            <div class="col-lg-6">
                                <h5 class="mb-3">Edit Payment Gateway</h5>
                                <form method="POST" action="<?php echo e(route('manage.general.setting.gateway')); ?>">
                                    <?php echo csrf_field(); ?>
                                    <div class="row mb-3">
                                        <label class="col-sm-4 col-form-label">Status</label>
                                        <div class="col-sm-8">
                                            <div class="form-check">
                                                <input class="form-check-input" type="checkbox" name="ipaymu_is_active" value="1" id="ipaymuActive" <?php echo e(($gateway->ipaymu_is_active ?? false) ? 'checked' : ''); ?>>
                                            ...
                                            <select class="form-select" name="ipaymu_mode">
                                                <option value="sandbox" <?php echo e(($gateway->ipaymu_mode ?? 'sandbox') == 'sandbox' ? 'selected' : ''); ?>>Sandbox</option>
                                                <option value="production" <?php echo e(($gateway->ipaymu_mode ?? 'sandbox') == 'production' ? 'selected' : ''); ?>>Production</option>
                                                    </select>
                                        ...
                                        <label class="col-sm-4 col-form-label">VA Key</label>
                                                    <div class="col-sm-8">
                                            <input type="text" class="form-control" name="ipaymu_va" value="<?php echo e(old('ipaymu_va', $gateway->ipaymu_va ?? '')); ?>" placeholder="Masukkan VA Key dari iPaymu">
                                        ...
                                        <label class="col-sm-4 col-form-label">API Key</label>
                                                    <div class="col-sm-8">
                                            <input type="text" class="form-control" name="ipaymu_api_key" value="<?php echo e(old('ipaymu_api_key', $gateway->ipaymu_api_key ?? '')); ?>" placeholder="Masukkan API Key dari iPaymu">
                    ...
                    <div id="tab-wa" class="tab-pane-setting">
                            ...
                            <div class="alert alert-warning" role="alert">
                                <div class="d-flex align-items-center">
                                    ...
                                    <div>
                                        ...
                                        <a href="<?php echo e(route('manage.addons.show', 'whatsapp-gateway')); ?>" class="btn btn-primary">
                        ...
                        <div class="row">
                            <div class="col-lg-6">
                                ...
                                <table class="table table-bordered">
                                    <tr><th width="200">Status Notifikasi</th><td><?php echo e($gateway->enable_wa_notification ? 'Aktif' : 'Tidak Aktif'); ?></td></tr>
                                    <tr><th>URL Gateway</th><td><?php echo e($gateway->url_wagateway ?? '-'); ?></td></tr>
                                    <tr><th>API Key</th><td><?php echo e($gateway->apikey_wagateway ? '***' . substr($gateway->apikey_wagateway, -4) : '-'); ?></td></tr>
                                    <tr><th>Sender</th><td><?php echo e($gateway->sender_wagateway ?? '-'); ?></td></tr>
                                    <tr><th>No. WhatsApp</th><td><?php echo e($gateway->wa_gateway ?? '-'); ?></td></tr>
                                </table>
                            </div>
                            <div class="col-lg-6">
                                ...
                                <form method="POST" action="<?php echo e(route('manage.general.setting.gateway')); ?>">
                                    ...
                                    <div class="row mb-3">
                                        ...
                                        <div class="col-sm-8">
                                            <div class="form-check">
                                                <input class="form-check-input" type="checkbox" name="enable_wa_notification" value="1" id="waNotificationActive" <?php echo e(($gateway->enable_wa_notification ?? false) ? 'checked' : ''); ?>>
                                    ...
                                    <div class="row mb-3">
                                        ...
                                        <div class="col-sm-8">
                                            <input type="url" class="form-control" name="url_wagateway" value="<?php echo e(old('url_wagateway', $gateway->url_wagateway ?? '')); ?>">
                                        </div>
                                    </div>
                                    <div class="row mb-3">
                                        <label class="col-sm-4 col-form-label">API Key</label>
                                        <div class="col-sm-8">
                                            <input type="text" class="form-control" name="apikey_wagateway" value="<?php echo e(old('apikey_wagateway', $gateway->apikey_wagateway ?? '')); ?>">
                                        </div>
                                    </div>
                                    <div class="row mb-3">
                                        <label class="col-sm-4 col-form-label">Sender</label>
                                        <div class="col-sm-8">
                                            <input type="text" class="form-control" name="sender_wagateway" value="<?php echo e(old('sender_wagateway', $gateway->sender_wagateway ?? '')); ?>">
                                        </div>
                                    </div>
                                    <div class="row mb-3">
                                        <label class="col-sm-4 col-form-label">No. WhatsApp</label>
                                        <div class="col-sm-8">
                                            <input type="text" class="form-control" name="wa_gateway" value="<?php echo e(old('wa_gateway', $gateway->wa_gateway ?? '')); ?>">
                                        </div>
                                    </div>
...
<?php $__env->stopSection(); ?> 
<?php echo $__env->make('layouts.adminty', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\sppqu\sppqu_addon\resources\views/general-setting.blade.php ENDPATH**/ ?>