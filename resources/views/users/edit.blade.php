                    ...
                    <form method="POST" action="{{ route('manage.users.update', $user->id) }}">
                        ...
                        <div class="mb-3">
                            ...
                            <select name="is_bk" class="form-select" id="is_bk_select">
                                <option value="0" {{ old('is_bk', $user->is_bk ?? 0)==0 ? 'selected' : '' }}>Tidak</option>
                                <option value="1" {{ old('is_bk', $user->is_bk ?? 0)==1 ? 'selected' : '' }}>Ya</option>
                            </select>
                        ...
                        <div class="mb-3">
                            ...
                            <select name="spmb_admin_access" class="form-select">
                                <option value="0" {{ old('spmb_admin_access', $user->spmb_admin_access ?? 0)=='0' ? 'selected' : '' }}>Tidak</option>
                                <option value="1" {{ old('spmb_admin_access', $user->spmb_admin_access ?? 0)=='1' ? 'selected' : '' }}>Ya</option>
                            </select>
