            ...
            <div class="card">
                <div class="card-header">
                    <h4 class="card-title mb-0">
                        <i class="fa fa-credit-card me-2"></i>Tambah Metode Pembayaran
                    </h4>
                </div>
                <div class="card-body">
                    <form action="{{ route('manage.accounting.payment-methods.store') }}" method="POST">
                        @csrf
                        <div class="row">
                            <div class="col-md-6">
                                <div class="mb-3">
                                    <label for="kode_metode" class="form-label">
                                        Kode Metode <span class="text-danger">*</span>
                                    </label>
                                    <input type="text" class="form-control @error('kode_metode') is-invalid @enderror" 
                                           id="kode_metode" name="kode_metode" value="{{ old('kode_metode') }}" required>
                                    @error('kode_metode')
                        ...
                        <div class="d-flex justify-content-between">
                            <a href="{{ route('manage.accounting.payment-methods.index') }}" class="btn btn-secondary">
