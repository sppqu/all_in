...
<div class="container-fluid px-4">
    ...
    <div class="mb-4">
        <h2 class="mb-1 fw-bold text-dark">
            <i class="fas fa-edit me-2 text-warning"></i>Edit Bimbingan Konseling
        </h2>
        <p class="text-muted mb-0">Perbarui data bimbingan konseling siswa</p>
    </div>

    <!-- Form Card -->
    <div class="card border-0 shadow-sm">
        <div class="card-body">
            <form action="{{ route('manage.bk.bimbingan.update', $bimbingan->bimbingan_id) }}" method="POST">
                @csrf
                @method('PUT')
                ...
                <div class="row g-4">
                        ...
                        <select name="siswa_id" class="form-control @error('siswa_id') is-invalid @enderror" id="siswa_id" required>
                            ...
                            @forelse($students as $student)
                                <option value="{{ $student->student_id }}" 
                                    {{ old('siswa_id', $bimbingan->siswa_id) == $student->student_id ? 'selected' : '' }}>
                    ...
                    <div class="col-md-6">
                        ...
                        <input type="date" name="tanggal_bimbingan" 
                               ...
                               value="{{ old('tanggal_bimbingan', $bimbingan->tanggal_bimbingan->format('Y-m-d')) }}" required>
                    ...
                    <div class="col-md-4">
                        ...
                        <select name="jenis_bimbingan" class="form-control select-primary @error('jenis_bimbingan') is-invalid @enderror" required>
                            ...
                            <option value="sosial" {{ old('jenis_bimbingan', $bimbingan->jenis_bimbingan) == 'sosial' ? 'selected' : '' }}>Sosial</option>
                            <option value="karir" {{ old('jenis_bimbingan', $bimbingan->jenis_bimbingan) == 'karir' ? 'selected' : '' }}>Karir</option>
                        </select>
                    ...
                    <div class="col-md-4">
                        ...
                        <select name="kategori" class="form-control select-primary @error('kategori') is-invalid @enderror" required>
                            ...
                            <option value="berat" {{ old('kategori', $bimbingan->kategori) == 'berat' ? 'selected' : '' }}>Berat</option>
                        </select>
                        @error('kategori')
                            <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
                    ...
                    <div class="col-md-4">
                        ...
                        <input type="number" name="sesi_ke" 
                               ...
                               value="{{ old('sesi_ke', $bimbingan->sesi_ke) }}" min="1" required>
                        @error('sesi_ke')
                            <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
                    </div>
                    ...
                    <div class="col-md-6">
                        ...
                        <select name="status" class="form-control select-primary @error('status') is-invalid @enderror" required>
                            ...
                            <option value="ditunda" {{ old('status', $bimbingan->status) == 'ditunda' ? 'selected' : '' }}>Ditunda</option>
                        </select>
                        @error('status')
                            <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
                    ...
                    <div class="col-md-12">
                        ...
                        <textarea name="permasalahan" rows="4" 
                                  ...
                                  placeholder="Deskripsikan permasalahan yang dihadapi siswa..." required>{{ old('permasalahan', $bimbingan->permasalahan) }}</textarea>
                        @error('permasalahan')
                            <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
                    </div>
                    ...
                    <div class="col-md-12">
                        ...
                        <textarea name="analisis" rows="3" 
                                  ...
                                  placeholder="Analisis terhadap permasalahan (opsional)...">{{ old('analisis', $bimbingan->analisis) }}</textarea>
                        @error('analisis')
                            <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
                    </div>
                    ...
                    <div class="col-md-12">
                        ...
                        <textarea name="tindakan" rows="3" 
                                  ...
                                  placeholder="Tindakan atau solusi yang diberikan (opsional)...">{{ old('tindakan', $bimbingan->tindakan) }}</textarea>
                        @error('tindakan')
                            <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
                    </div>
                    ...
                    <div class="col-md-12">
                        ...
                        <textarea name="hasil" rows="3" 
                                  ...
                                  placeholder="Hasil dari bimbingan (opsional)...">{{ old('hasil', $bimbingan->hasil) }}</textarea>
                        @error('hasil')
                            <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
                    </div>
                    ...
                    <div class="col-md-12">
                        ...
                        <textarea name="catatan" rows="2" 
                                  ...
                                  placeholder="Catatan tambahan (opsional)...">{{ old('catatan', $bimbingan->catatan) }}</textarea>
                        @error('catatan')
                            <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
                    </div>
