...
@section('title', 'Pembayaran Addon - SPPQU')

@section('active_menu', 'menu.addons')
        ...
        <div class="col-lg-8">
            ...
            <div class="card shadow-sm mb-4">
                <div class="card-header bg-primary text-white">
                    <h5 class="mb-0">
                        ...
                        Detail Pembayaran Addon
                    </h5>
                </div>
                <div class="card-body">
                    <div class="row">
                        <div class="col-md-6">
                            <h6 class="text-muted mb-3">Informasi Addon</h6>
                            <table class="table table-sm table-borderless">
                                ...
                                <tr>
                                    ...
                                    <td class="text-success fw-bold">Rp {{ number_format($addon->price, 0, ',', '.') }}</td>
                                </tr>
                                <tr>
                                    <td><strong>Tipe:</strong></td>
                                    <td>
                                        @if($addon->type === 'one_time')
                                            <span class="badge bg-success">One-Time (Lifetime)</span>
                                        @else
            ...
            <div class="card shadow-sm mb-4">
                ...
                <div class="card-body">
                    ...
                    <div class="alert alert-info mt-3">
                        ...
                        <p class="mb-0 mt-2 small">Transaksi Anda dilindungi dan diproses secara otomatis. Setelah pembayaran berhasil, addon akan langsung aktif.</p>
                    </div>
                </div>
            </div>
            ...
            <div class="alert alert-secondary mt-4">
                ...
                <ul class="mb-0 small">
                    ...
                    <li>Setelah pembayaran berhasil, addon langsung aktif</li>
                    @if($addon->type === 'one_time')
                        <li>Addon ini bersifat lifetime (tidak perlu perpanjangan)</li>
                    @endif
...
function checkPaymentStatus() {
    console.log('Auto-checking addon payment status...', referenceId);
    
    fetch('{{ route('manage.addons.check-payment') }}', {
        method: 'POST',
        headers: {
        ...
        .then(data => {
            console.log('Addon payment status:', data);
...
setTimeout(() => {
    console.log('Starting auto-refresh addon payment status...');
