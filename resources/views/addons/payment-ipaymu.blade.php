        ...
        <div class="col-lg-8">
            ...
            <div class="card shadow-sm mb-4">
                ...
                <div class="card-body">
                    <div class="row">
                        <div class="col-md-6">
                            <h6 class="text-muted mb-3">Informasi Add-on</h6>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        @if($addon->type === 'recurring')
                                            <span class="badge bg-info">Berlangganan ({{ $addon->duration }} hari)</span>
                                        @else
                                            <span class="badge bg-success">Satu Kali</span>
                                        @endif
                                    </td>
                                </tr>
                                <tr>
            ...
            <div class="card shadow-sm mb-4">
                ...
                <div class="card-body">
                    ...
                    <div class="row mt-4">
                        ...
                        <div class="col-md-6">
                            <div class="mb-3">
                                ...
                                <div class="input-group">
                                    <input type="text" class="form-control fw-bold text-success" value="Rp {{ number_format($addon->price, 0, ',', '.') }}" readonly>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="alert alert-info mt-3">
                        ...
                        <p class="mb-0 mt-2 small">Transaksi Anda dilindungi dan diproses secara otomatis. Setelah pembayaran berhasil, add-on akan langsung aktif.</p>
                    </div>
                </div>
            </div>
            ...
            <div class="alert alert-secondary mt-4">
                ...
                <ul class="mb-0 small">
                    ...
                    <li>Setelah pembayaran berhasil, add-on langsung aktif dan dapat digunakan</li>
