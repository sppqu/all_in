        ...
        <div class="col-md-8">
            <div class="card">
                <div class="card-header d-flex justify-content-between align-items-center">
                    <h4 class="mb-0">Edit Peserta Didik</h4>
                            ...
                            <div class="col-md-6">
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="text" 
                                           ...
                                           id="student_nis" 
                                           name="student_nis" 
                                           value="{{ old('student_nis', $student->student_nis) }}" 
                                           maxlength="45"
                                           required>
                                    @error('student_nis')
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="text" 
                                           ...
                                           value="{{ old('student_full_name', $student->student_full_name) }}" 
                                           maxlength="255"
                                           required>
                                    ...
                                    <div class="col-md-6">
                                        <div class="mb-3">
                                            ...
                                            <input type="date" 
                                                   ...
                                                   value="{{ old('student_born_date', $student->student_born_date ? $student->student_born_date->format('Y-m-d') : '') }}"
                                                   required>
                                ...
                                <div class="mb-3">
                                    ...
                                    <select class="form-select @error('class_class_id') is-invalid @enderror" 
                                        ...
                                        @foreach($classes as $class)
                                            <option value="{{ $class->class_id }}" {{ old('class_class_id', $student->class_class_id) == $class->class_id ? 'selected' : '' }}>
                                                {{ $class->class_name }}
                                            </option>
                                        @endforeach
                                    </select>
                                ...
                                <div class="mb-3">
                                    <div class="form-check">
                                        <input class="form-check-input" 
                                               ...
                                               name="student_status" 
                                               value="1" 
                                               {{ old('student_status', $student->student_status) ? 'checked' : '' }}>
