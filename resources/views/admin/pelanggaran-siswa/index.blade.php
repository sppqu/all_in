                                ...
                                <tr>
                                    ...
                                    <td class="text-center">
                                        <div class="btn-group btn-group-sm">
                                            <a href="{{ route('manage.bk.pelanggaran-siswa.show', $item->id) }}" class="btn btn-info" title="Detail">
                                                <i class="fas fa-eye"></i>
                                            </a>
                                            <a href="{{ route('manage.bk.pelanggaran-siswa.edit', $item->id) }}" class="btn btn-warning" title="Edit">
