...
<head>
    ...
    <title>Edit Kejuruan SPMB - Admin</title>
    ...
    <nav class="navbar navbar-expand-lg navbar-dark">
        <div class="container">
            <a class="navbar-brand fw-bold" href="{{ route('manage.spmb.kejuruan.index') }}">
                <i class="fas fa-edit me-2"></i>Edit Kejuruan SPMB
            </a>
                ...
                <div class="form-card">
                    <div class="p-4">
                        <div class="d-flex justify-content-between align-items-center mb-4">
                            ...
                            <span class="badge bg-info">{{ $kejuruan->kode_kejuruan }}</span>
                        </div>

                        <form method="POST" action="{{ route('manage.spmb.kejuruan.update', $kejuruan->id) }}">
                            @csrf
                            @method('PUT')
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-8 mb-3">
                                    ...
                                    <input type="text" 
                                           ...
                                           id="nama_kejuruan" 
                                           name="nama_kejuruan" 
                                           value="{{ old('nama_kejuruan', $kejuruan->nama_kejuruan) }}"
                                ...
                                <div class="col-md-4 mb-3">
                                    ...
                                    <input type="text" 
                                           ...
                                           id="kode_kejuruan" 
                                           name="kode_kejuruan" 
                                           value="{{ old('kode_kejuruan', $kejuruan->kode_kejuruan) }}"
                            ...
                            <div class="mb-3">
                                ...
                                <textarea class="form-control @error('deskripsi') is-invalid @enderror" 
                                          ...
                                          name="deskripsi" 
                                          rows="3" 
                                          placeholder="Deskripsi kejuruan...">{{ old('deskripsi', $kejuruan->deskripsi) }}</textarea>
                                @error('deskripsi')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            </div>
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6 mb-3">
                                    ...
                                    <input type="number" 
                                           ...
                                           id="kuota" 
                                           name="kuota" 
                                           value="{{ old('kuota', $kejuruan->kuota) }}"
                                           min="0" 
                                ...
                                <div class="col-md-6 mb-3">
                                    ...
                                    <select class="form-select @error('aktif') is-invalid @enderror" 
                                            id="aktif" 
                                            name="aktif">
                                        <option value="1" {{ old('aktif', $kejuruan->aktif) == '1' ? 'selected' : '' }}>
                                            Aktif
                                        </option>
                                        <option value="0" {{ old('aktif', $kejuruan->aktif) == '0' ? 'selected' : '' }}>
                                            Tidak Aktif
                                        </option>
                                    </select>
                                    @error('aktif')
