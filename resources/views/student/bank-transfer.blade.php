...
<div class="container-fluid">
    ...
    <div class="d-flex justify-content-between align-items-center mb-4">
        <div class="d-flex align-items-center">
            <a href="{{ route('student.cart') }}" class="text-decoration-none me-3">
        ...
        <div class="col-lg-8">
            <div class="card bank-info-card mb-4">
                <div class="card-body p-4">
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <div class="bank-detail">
                                ...
                                <div class="bank-detail-value">{{ $schoolBank->nama_bank ?? 'BCA' }}</div>
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="bank-detail">
                                ...
                                <div class="d-flex align-items-center">
                                    <div class="bank-detail-value me-2">{{ $schoolBank->norek_bank ?? '1234567890' }}</div>
                                    <button class="copy-btn" onclick="copyToClipboard('{{ $schoolBank->norek_bank ?? '1234567890' }}')">
                    ...
                    <div class="bank-detail">
                        ...
                        <div class="bank-detail-value">{{ $schoolBank->nama_rekening ?? 'SMK SPPQU DIGITAL PAYMENT' }}</div>
                    </div>
                </div>
            </div>
                ...
                <div class="instruction-step">
                    ...
                    <div class="step-content">
                        ...
                        <div class="step-description">
                            Transfer sejumlah <strong>Rp {{ number_format($totalAmount, 0, ',', '.') }}</strong> ke rekening sekolah yang tertera di atas
                        </div>
                    </div>
                </div>
            ...
            <div class="card payment-summary">
                <div class="card-body p-4">
                    ...
                    <form id="transferForm" method="POST" action="{{ route('student.bank-transfer.process') }}" enctype="multipart/form-data">
                        @csrf
            ...
            <div class="card payment-summary sticky-top" style="top: 20px;">
                <div class="card-body p-4">
                    ...
                    @foreach($cartItems as $item)
                        <div class="bill-item">
                            <div class="d-flex justify-content-between align-items-start">
                                ...
                                <div class="text-end">
                                    <div class="fw-bold text-success">{{ $item['amount'] }}</div>
                                </div>
                            </div>
                        </div>
                    @endforeach
                    ...
                    <div class="d-flex justify-content-between align-items-center">
                        ...
                        <h5 class="mb-0 fw-bold text-success">Rp {{ number_format($totalAmount, 0, ',', '.') }}</h5>
                    </div>
