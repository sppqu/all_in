...
<body>
        ...
        <div class="container">
            <a class="navbar-brand fw-bold" href="#">
                @if($schoolProfile && $schoolProfile->logo_sekolah)
                    <img src="{{ asset('storage/' . $schoolProfile->logo_sekolah) }}" alt="{{ $schoolProfile->nama_sekolah }} Logo" height="30" class="me-2">
                @else
            ...
            <div class="navbar-nav ms-auto">
                <a class="btn btn-primary ms-2" href="{{ route('spmb.register') }}">Daftar Sekarang</a>
            </div>
        </div>
    </nav>
            ...
            <div class="row align-items-center">
                <div class="col-lg-6">
                    <h1 class="welcome-title">
                        ...
                        <span class="brand-text">{{ $schoolProfile->nama_sekolah ?? 'SPPQU' }}</span>
                    </h1>
                    ...
                    <div class="d-flex gap-3">
                        <a href="{{ route('spmb.register') }}" class="btn btn-light btn-lg">
                            <i class="fas fa-user-plus me-2"></i>Daftar Sekarang
                        </a>
                        <a href="{{ route('spmb.login') }}" class="btn btn-outline-light btn-lg">
            ...
            <div class="row align-items-center">
                <div class="col-md-6 mb-2 mb-md-0">
                    <h5 class="mb-1" style="font-size: 1rem;">
                        @if($schoolProfile && $schoolProfile->logo_sekolah)
                            <img src="{{ asset('storage/' . $schoolProfile->logo_sekolah) }}" alt="{{ $schoolProfile->nama_sekolah }} Logo" height="18" class="me-2">
                        @else
                            <i class="fas fa-graduation-cap me-2"></i>
                        @endif
                        SPMB {{ $schoolProfile->nama_sekolah ?? 'SPPQU' }}
                    </h5>
                    <p class="mb-0" style="font-size: 0.85rem;">Sistem Penerimaan Murid Baru {{ $schoolProfile->nama_sekolah ?? 'SPPQU' }}</p>
                </div>
                <div class="col-md-6 text-md-end">
                    <p class="mb-0" style="font-size: 0.85rem;">&copy; {{ date('Y') }} SPMB {{ $schoolProfile->nama_sekolah ?? 'SPPQU' }}. All rights reserved.</p>
                </div>
            </div>
        </div>
    </footer>
    ...
    <a href="https://wa.me/{{ $whatsappNumber ?? '6281234567890' }}?text=Halo,%20saya%20ingin%20bertanya%20tentang%20SPMB" 
       target="_blank" 
