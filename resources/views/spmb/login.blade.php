            ...
            <div class="col-md-6 col-lg-4">
                <div class="login-card">
                    <div class="login-header">
                        ...
                        @endif
                        <h3 class="mb-0">Login SPMB {{ $schoolProfile->nama_sekolah ?? 'SPPQU' }}</h3>
                    ...
                    <div class="login-body">
                        ...
                        <form method="POST" action="{{ route('spmb.login.post') }}">
                            @csrf
                            <div class="mb-3">
                            ...
                            <div class="mb-4">
                                <label for="password" class="form-label">Password (6 digit terakhir HP)</label>
                                <div class="input-group">
                                    <span class="input-group-text">
                                ...
                                <div class="d-flex justify-content-between align-items-center mt-2">
                                    <small class="text-muted">Password adalah 6 digit terakhir dari nomor HP Anda</small>
                                    <a href="{{ route('spmb.forgot-password') }}" class="text-decoration-none" style="font-size: 0.85rem;">
                                        Lupa Password?
                                    </a>
                                </div>
                            </div>
                        ...
                        <div class="text-center">
                            ...
                            <a href="{{ route('spmb.register') }}" class="btn btn-outline-primary w-100">
