                                ...
                                <div class="col-md-12">
                                    <div class="card border-success">
                                        <div class="card-body text-center">
                                            ...
                                            <a href="{{ route('online-payment.history') }}" class="btn btn-success" style="color: white;">
                            ...
                            <div class="card bg-light">
                                ...
                                <div class="card-body">
                                    <div class="row text-center">
                                        <div class="col-6">
                                            <div class="border-end">
                                                <h4 class="text-primary">{{ $totalPayments ?? 0 }}</h4>
                                                <small class="text-muted">Total Pembayaran</small>
                                            </div>
                                        </div>
                                        <div class="col-6">
                                            <h4 class="text-success">{{ $successPayments ?? 0 }}</h4>
                                    ...
                                    <div class="row text-center">
                                        ...
                                        <div class="col-6">
                                            <h4 class="text-danger">{{ $failedPayments ?? 0 }}</h4>
