        ...
        <div class="col-md-6">
            <div class="card">
                <div class="card-header">
                    <h4 class="mb-0">Tambah Pos Pembayaran</h4>
                </div>
                <div class="card-body">
                    <form action="{{ route('pos.store') }}" method="POST">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" name="pos_name" id="pos_name" class="form-control @error('pos_name') is-invalid @enderror" value="{{ old('pos_name') }}" required>
                            @error('pos_name')<div class="invalid-feedback">{{ $message }}</div>@enderror
                        </div>
                        <div class="mb-3">
                            <label for="pos_description" class="form-label">Deskripsi</label>
                            <input type="text" name="pos_description" id="pos_description" class="form-control @error('pos_description') is-invalid @enderror" value="{{ old('pos_description') }}">
